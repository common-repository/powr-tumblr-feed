<?php
    ...
    Plugin URI: https://www.powr.io/plugins/tumblr-feed
    ...
    */
    ...
    function powr_tumblr_feed_options() {
      if(powr_local_mode()){//Determine JS url:
        $redirect_url = 'https://localhost:3000/wp-create/tumblr-feed';
      }else{
        $redirect_url = 'https://www.powr.io/wp-create/tumblr-feed';
      }
